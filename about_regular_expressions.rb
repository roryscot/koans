...
class AboutRegularExpressions < Neo::Koan
  ...
  def test_asterisk_means_zero_or_more
    ...
    assert_equal "a", "abbcccddddeeeee"[/az*/]
    # if string == "aaaaz" this will return "a"
    ...
    # It would return nil if it was searching for a symbol
  end
  ...
  # They return as many as possilbe?
  ...
  def test_character_classes_give_options_for_a_character
    ...
    # NOTE: LOOK AT HOW USEFUL THOSE BRACKETS STARTING AT XX:65 (IN ABOVE LINE)
    # ARE !!!
  end
  ...
  def test_slash_w_is_a_shortcut_for_a_word_character_class
    ...
    assert_equal "variable_1", "variable_1 = 42"[/[a-zA-Z0-9_]+/]
      #what does the low dash after the 9 indicate?
  ...
  def test_slash_a_anchors_to_the_start_of_the_string
    ...
    # here there is only a match if the matching word is
  ...
  def test_slash_b_anchors_to_a_word_boundary
    ...
    # The period allows for another letter
  end
  ...
  def test_parentheses_group_contents
    ...
    # The group is repeated, and is therefore picked up by the +
  end
  ...
  def test_variables_can_also_be_used_to_access_captures
    assert_equal "Gray, James", "Name:  Gray, James"[/(\w+), (\w+)/]
      #How does this work? Why doesn't it pick up "Name:"
    assert_equal "Gray", $1
