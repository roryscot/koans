...
EOS
  ...
  def test_the_shovel_operator_modifies_the_original_string
    ...
    # NOTE: original_string must be modified vicariously through hi because
    # hi must simply point to it in memory
    ...
    # The built-up string will be saved as such
  end
  ...
  def test_you_can_get_a_single_character_from_a_string
    ...
    # NOTE: A string is actually an array of characters. (An array is actually a linked list? )
  end
